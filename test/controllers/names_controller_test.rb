...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference("Name.count") do
      post names_url, params: { name: { description: @name.description, service_cost: @name.service_cost, service_name: @name.service_name } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { description: @name.description, service_cost: @name.service_cost, service_name: @name.service_name } }
